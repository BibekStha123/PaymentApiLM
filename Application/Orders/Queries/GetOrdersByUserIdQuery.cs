...
{
    public record GetOrdersByUserIdQuery(Guid UserId, Guid? Cursor, int Limit) : IRequest<CursorPagedResponse<OrderResponse>>;

    public class GetOrdersByUserIdQueryHandler : IRequestHandler<GetOrdersByUserIdQuery, CursorPagedResponse<OrderResponse>>
    {
        private readonly PaymentDetailsContext _context;

        public GetOrdersByUserIdQueryHandler(PaymentDetailsContext context)
        {
            _context = context;
        }

        public async Task<CursorPagedResponse<OrderResponse>> Handle(GetOrdersByUserIdQuery request, CancellationToken cancellationToken)
        {

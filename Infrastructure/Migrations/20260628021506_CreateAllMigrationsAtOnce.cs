...
{
    /// <inheritdoc />
    public partial class CreateAllMigrationsAtOnce : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                INSERT INTO PaymentDetailDb.dbo.Currency (Id, CurrencyCode, Name, ModifiedDate)
                SELECT NEWID(), CurrencyCode, Name, ModifiedDate
